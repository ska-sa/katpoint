...
sphere_to_plane_select = {'SIN' : sphere_to_plane_sin,
                          'TAN' : sphere_to_plane_tan,
                          'ARC' : sphere_to_plane_arc,
                          'STG' : sphere_to_plane_stg}

plane_to_sphere_select = {'SIN' : plane_to_sphere_sin,
...
def sphere_to_plane(antenna, target, az, el, timestamp, projection_type='ARC', coord_system='azel'):
    ...
    if coord_system == 'radec':
        ...
        ref_ra, ref_dec = target.radec(timestamp, antenna)
        ...
        ref_az, ref_el = target.azel(timestamp, antenna)
