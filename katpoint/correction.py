...
class PointingModel(object):
    ...
    def __str__(self):
        ...
        descr = ['P1 = %s deg (az offset = encoder bias - tilt around)',
                 ...
                 'P7 = %s deg (el offset = encoder bias - forward axis skew - el box offset)',
                 'P8 = %s deg (maximum el gravitational sag)',
                 'P9 = %s (ad hoc el excess scale factor)',
                 'P10 = %s deg (ad hoc cos(el) term in delta_el, same as P8)',
                 'P11 = %s deg (ad hoc sin(el) term in delta_el)',
                 'P12 = %s (ad hoc az excess scale factor)',
                 'P13 = %s deg (ad hoc cos(az) term in delta_az)',
                 'P14 = %s deg (ad hoc sin(az) term in delta_az)',
                 'P15 = %s deg (ad hoc cos(2az) term in delta_el)',
                 'P16 = %s deg (ad hoc sin(2az) term in delta_el)',
                 'P17 = %s deg (ad hoc cos(2az) term in delta_az)',
                 'P18 = %s deg (ad hoc sin(2az) term in delta_az)',
                 'P19 = %s deg (ad hoc cos(8el) term in delta_el)',
